...
#define SSD1306_GPIO_PERIPH   (RCC_APB2Periph_GPIOA )


// SSD1306 (Data/Command select) pin (PB4)
...
// SSD1306 CS (Chip Select) pin (PA14)
...
#define SSD1306_CS_L()        (SSD1306_CS_PORT->BSRR = SSD1306_CS_PIN << 16)
  ...
  // SSD1306 D1 (Chip DATA) pin (PB8)
#define SSD1306_SDO_PORT       GPIOB
#define SSD1306_SDO_PIN        GPIO_Pin_8
#define SSD1306_SDO_H()        (SSD1306_SDO_PORT->BSRR = SSD1306_SDO_PIN)
#define SSD1306_SDO_L()        (SSD1306_SDO_PORT->BSRR = SSD1306_SDO_PIN << 16)

 // SSD1306 D0 (Chip CLOCK) pin (PB9)
#define SSD1306_CLK_PORT       GPIOB
#define SSD1306_CLK_PIN        GPIO_Pin_9
#define SSD1306_CLK_H()        (SSD1306_CLK_PORT->BSRR = SSD1306_CLK_PIN)
#define SSD1306_CLK_L()        (SSD1306_CLK_PORT->BSRR = SSD1306_CLK_PIN << 16)
...
uint16_t LCD_PutStr(uint8_t X, uint8_t Y, const char *str, const Font_TypeDef *Font, uint8_t *font_Data);
